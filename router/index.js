...
export const asyncRoutes = [
  {
    ...
    children: [{
      path: 'checking',
      component: () =>
        import ('@/views/business/checking'),
      name: 'Checking',
      meta: { title: '审批中' }
    },
    {
    ...
    },
    {
      path: 'all',
      component: () =>
        import ('@/views/business/all'),
      name: 'All',
      meta: { title: '全部业务' }
    },
    {
      path: 'red-light-record',
      component: () =>
        import ('@/views/business/red-light-record'),
      name: 'RedLightRecord',
      meta: { title: '亮红灯记录' }
    }
    ]
  },
  {
    path: '/reports',
    component: Layout,
    redirect: '/reports/node-statistics',
    name: 'Business',
    meta: {
      title: '统计报表',
      icon: 'notice'
    ...
    children: [{
      ...
      component: () =>
        import ('@/views/reports/node-statistics'),
      name: 'NodeStatistics',
      meta: { title: '业务节点统计' }
    },
    {
      path: 'proportion',
      component: () =>
        import ('@/views/reports/proportion'),
      name: 'Proportion',
      meta: { title: '业务占比情况' }
    },
    {
